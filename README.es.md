...
* **Core 1 (`task_gui_core1`):** Dibuja la interfaz ST7789 vía SPI DMA limitada a ~25 FPS (periodo de 40ms) para garantizar animaciones fluidas sin agotar los recursos del sistema. Maneja la lectura de botones vía ADC1, gestiona las transiciones de estado de la interfaz, actualiza la superposición del reloj en tiempo real y orquesta la secuencia de apagado seguro.
